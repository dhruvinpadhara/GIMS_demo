...
<!-- Page content -->
       ...
       <!--   <p>
            ...
            <div class="card-body">
                 <form id="employee_form" autocomplete="off">
                        ...
                        <div class="row">
                           ...
                           <div class="form-group col-md-1 float-left courier">
                              <label>Against Form</label>
                              <input type="text" id="against_form" class="form-control" name="agform" placeholder="enter Doc.No." required="required" />
                           </div>
                           <div class="form-group col-md-2 float-left courier">
                              <label>Received form no</label>
                              <input type="number" id="rcvdFormNo" class="form-control" name="rcvdFormNo" placeholder="Received form no" required="required" />
                           </div>
                        </div>
                        <br>
                        <div class="row">
         ...
         <!-- /basic initialization -->
<script src="<c:url value='assets/admin/js/pg_js/transaction/retail_bill.js'/>"></script>