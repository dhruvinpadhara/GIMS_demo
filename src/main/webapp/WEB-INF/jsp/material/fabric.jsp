...
<!-- Page content -->
         <p>
            <button data-toggle="modal" data-target="#add_form"  type="button" class="btn btn-success btn-labeled btn-labeled-left btn-sm"><b><i class="icon-plus2"></i></b> Add Fabric</button>
         </p>
            ...
            <div class="modal-dialog modal-full">
               <div class="modal-content">
                  <div class="modal-header">
                     <h5 class="modal-title" id="myLargeModalLabel">Fabric</h5>
...
<!-- /page content -->
<script src="<c:url value='assets/admin/js/pg_js/material/fabric.js' />"></script>