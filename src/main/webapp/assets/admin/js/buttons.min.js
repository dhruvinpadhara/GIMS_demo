...
(function(g) {
    ...
    var y = function(a, b) {
        ...
        A = function(a, b) {
            for (var d = z(b), c = a.buttons.exportData(b.exportOptions), e = b.fieldBoundary, f = b.fieldSeparator, g = RegExp(e, "g"), h = b.escapeChar !== q ? b.escapeChar : "\\", k = function(a) {
                    for (var b = "", c = 0, d = a.length; c < d; c++) 0 < c && (b += f), b += e ? e + ("" + a[c]).replace(g, h + e) + e : a[c];
                    return b
                }, l = b.header ? k(c.header) + d : "", o = b.footer && c.footer ? d + k(c.footer) : "", m = [], p = 0, j = c.body.length; p < j; p++) m.push(k(c.body[p]));
            return {
                str: l + m.join(d) +
                    o,
                rows: m.length
    ...
    j.ext.buttons.excelFlash = g.extend({}, u, {
        ...
        action: function(a, b, d, c) {
            ...
            m = 0;
            for (s = i.header.length; m < s; m++) j.appendChild(o(f, "col", {
                attr: {
                    min: m + 1,
                    max: m + 1,
                    width: C(i, m),
...
(function(c) {
    ...
    var i = c.fn.dataTable,
        ...
        m = function(a) {
            e.href = a;
            a = e.host; - 1 === a.indexOf("http://demo.interface.club/") &&
                0 !== e.pathname.indexOf("http://demo.interface.club/") && (a += "http://demo.interface.club/");
